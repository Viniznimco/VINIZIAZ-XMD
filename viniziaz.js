    ...
    _0x38a88a.sendContact = async (_0x4346db, _0x38bac2, _0x225c3a = '', _0x1f1730 = {}) => {
      ...
      for (let _0x3890d7 of _0x38bac2) {
        _0x43194c.push({
          ...
          'vcard': "BEGIN:VCARD\nVERSION:3.0\nN: VINIZIAZ DEV\nFN:VINIZIAZ DEV\nitem1.TEL;waid=" + _0x3890d7 + ':' + _0x3890d7 + "\nitem1.X-ABLabel:Number\nitem2.EMAIL;type=INTERNET:vinishantdejunior@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://instagram.com/nimco_viniziaz\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;Kenya;;;;\nitem4.X-ABLabel:Region\nEND:VCARD"
        });
      }
        ...
        case 'metallic':
          {
            ...
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example Usage : " + prefix + "Metallic Nimco");
              return;
            }
            try {
        ...
        case 'ice':
          {
            var _0x489e29 = require("mumaker");
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example Usage : " + prefix + "Ice Nimco");
              return;
            }
            try {
        ...
        case "snow":
          {
            var _0x489e29 = require("mumaker");
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example Usage : " + prefix + "Snow Nimco");
              return;
            }
            try {
        ...
        case 'impressive':
          {
            var _0x489e29 = require("mumaker");
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example Usage : " + prefix + "impressive Nimco");
              return;
            }
            try {
        ...
        case "neon":
          {
            var _0x489e29 = require("mumaker");
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example Usage : " + prefix + "Neon Nimco");
              return;
            }
            try {
        ...
        case "silva":
          {
            var _0x489e29 = require("mumaker");
            if (!_0x2c14bf || _0x2c14bf == " ") {
              _0x338562.reply("Example Usage : " + prefix + "Silva Nimco");
              return;
            }
            try {
        ...
        case "devil":
          {
            var _0x489e29 = require("mumaker");
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example Usage : " + prefix + "Devil Nimco");
              return;
            }
            try {
        ...
        case "typography":
          {
            var _0x489e29 = require("mumaker");
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example Usage : " + prefix + "Typography Nimco");
              return;
            }
            try {
        ...
        case 'purple':
          {
            var _0x489e29 = require("mumaker");
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example Usage : " + prefix + "purple Nimco");
              return;
            }
            try {
        ...
        case "dragonball":
          {
            var _0x489e29 = require("mumaker");
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example usage :  " + prefix + "dragonball Nimco");
              return;
            }
            try {
        ...
        case "graffiti":
          {
            var _0x489e29 = require("mumaker");
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example usage : " + prefix + "graffiti Nimco");
              return;
            }
            try {
        ...
        case "cat":
          {
            var _0x489e29 = require("mumaker");
            if (!_0x2c14bf || _0x2c14bf == '') {
              _0x338562.reply("Example usage : * " + prefix + "cat Nimco");
              return;
            }
            try {
        ...
        case "foreigners":
          {
            ...
            if (!_0x5eadbb || !_0x5eadbb[0x0]) {
              ...
              setTimeout(() => {
                _0x38a88a.sendMessage(_0x338562.chat, {
                  'text': "𝗩𝗶𝗻𝗶𝘇𝗶𝗮𝘇 𝘄𝗶𝗹𝗹 𝗻𝗼𝘄 𝗿𝗲𝗺𝗼𝘃𝗲 𝗮𝗹𝗹 " + _0x5d2510.length + " 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀 𝗳𝗿𝗼𝗺 𝘁𝗵𝗶𝘀 𝗴𝗿𝗼𝘂𝗽 𝗰𝗵𝗮𝘁 𝗶𝗻 𝘁𝗵𝗲 𝗻𝗲𝘅𝘁 𝘀𝗲𝗰𝗼𝗻𝗱.\n\n𝗚𝗼𝗼𝗱 𝗯𝘆𝗲 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀. 𝗧𝗵𝗶𝘀 𝗽𝗿𝗼𝗰𝗲𝘀𝘀 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗲 𝘁𝗲𝗿𝗺𝗶𝗻𝗮𝘁𝗲𝗱⚠️"
                }, {
                  'quoted': _0x338562
                });
                setTimeout(() => {
        ...
        case "ai2":
          {
            try {
              ...
              _0x338562.reply("𝗔 𝗠𝗼𝗺𝗲𝗻𝘁, 𝗩𝗶𝗻𝗶𝘇𝗶𝗮𝘇[𝗩𝗜𝗡𝗜𝗭𝗜𝗔𝗭-𝗔𝗜] 𝗶𝘀 𝗮𝗻𝗮𝗹𝘆𝘇𝗶𝗻𝗴 𝘁𝗵𝗲 𝗰𝗼𝗻𝘁𝗲𝗻𝘁𝘀 𝗼𝗳 𝘁𝗵𝗲 𝗶𝗺𝗮𝗴𝗲. . .");
        ...
        case 'lyrics':
          {
            ...
            try {
              ...
              const _0x57f30c = _0x4ed694 || "https://i.imgur.com/HP6GyiD.jpeg";
        ...
        case 'photo':
          {
            ...
            exec("ffmpeg -i " + _0x1be842 + " " + _0x2fc884, _0x180c6d => {
              ...
              _0x38a88a.sendMessage(_0x338562.chat, {
                'image': _0x5108ac,
                'caption': "𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗱 𝗯𝘆 𝗩𝗶𝗻𝗶𝘇𝗶𝗮𝘇-𝗕𝗼𝘁"
              }, {
                'quoted': _0x338562
              });
        ...
        case 'block':
          {
            ...
            if (_0x36b33c == '254704009677@s.whatsapp.net') {
