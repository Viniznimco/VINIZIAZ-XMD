...
module.exports = viniziaz = async (_0x38a88a, _0x338562, _0x54bef0, _0x19773a) => {
  try {
    ...
    if (_0x2dea82 && !_0x338562.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ RAVEN-BOT ]")), !_0x563d(0x4d5) ? chalk.green(_0x3573be) : chalk.keyword("turquoise")(_0x215155), chalk.magenta("From"), chalk.green(_0x1d8ddf), chalk.yellow("[ " + _0x1d8ddf.sender.replace('@s.whatsapp.net', '') + " ]"));
