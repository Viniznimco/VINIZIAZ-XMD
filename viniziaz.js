        ...
        case "foreigners":
          {
            ...
            if (!args || !args[0]) {
              ...
              setTimeout(() => {
                client.sendMessage(m.chat, {
                  text: `𝗖𝗹𝗶𝗻𝘁𝗼𝗻 𝘄𝗶𝗹𝗹 𝗻𝗼𝘄 𝗿𝗲𝗺𝗼𝘃𝗲 𝗮𝗹𝗹 ${_0x2f8982.length} 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀 𝗳𝗿𝗼𝗺 𝘁𝗵𝗶𝘀 𝗴𝗿𝗼𝘂𝗽 𝗰𝗵𝗮𝘁 𝗶𝗻 𝘁𝗵𝗲 𝗻𝗲𝘅𝘁 𝘀𝗲𝗰𝗼𝗻𝗱.\n\n𝗚𝗼𝗼𝗱 𝗯𝘆𝗲 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀. 𝗧𝗵𝗶𝘀 𝗽𝗿𝗼𝗰𝗲𝘀𝘀 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗲 𝘁𝗲𝗿𝗺𝗶𝗻𝗮𝘁𝗲𝗱⚠️`
                }, {
                  quoted: m
                });
                setTimeout(() => {
        ...
        case "ai2":
          {
            try {
              ...
              m.reply("𝗔 𝗠𝗼𝗺𝗲𝗻𝘁, 𝗖𝗹𝗶𝗻𝘁𝗼𝗻[𝗩𝗜𝗡𝗜𝗭𝗜𝗔𝗭-𝗔𝗜] 𝗶𝘀 𝗮𝗻𝗮𝗹𝘆𝘇𝗶𝗻𝗴 𝘁𝗵𝗲 𝗰𝗼𝗻𝘁𝗲𝗻𝘁𝘀 𝗼𝗳 𝘁𝗵𝗲 𝗶𝗺𝗮𝗴𝗲. . .");
        ...
        case 'remini':
          {
            ...
            client.sendMessage(m.chat, {
              image: proses,
              caption: '𝗚𝗲𝗻𝗲𝗿𝗮𝘁𝗲𝗱 𝗯𝘆 𝗖𝗹𝗶𝗻𝘁𝗼𝗻-𝗫𝗺𝗱'
            }, {
              quoted: m
            });
          }
        ...
        case "kickall2":
          {
            ...
            try {
              ...
              await client.groupUpdateDescription(groupId, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 𝗖𝗹𝗶𝗻𝘁𝗼𝗻 𝗗𝗲𝘃 !");
        ...
        case "removebg":
          {
            try {
              ...
              let fdr = await client.downloadAndSaveMediaMessage(m.quoted);
              let fta = await uploadtoimgur(fdr);
              m.reply("𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝗖𝗹𝗶𝗻𝘁𝗼𝗻 𝗶𝘀 𝗲𝗿𝗮𝘀𝗶𝗻𝗴 𝘁𝗵𝗲 𝗯𝗮𝗰𝗸𝗴𝗿𝗼𝘂𝗻𝗱. . .");
              await client.sendMessage(m.chat, {
                image: {
...
🌅 Sunset: ${sunset.toLocaleTimeString()}`);
        ...
        case "group-vcf":
          {
            ...
            await m.reply('𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝗖𝗹𝗶𝗻𝘁𝗼𝗻 𝗶𝘀 𝗖𝗼𝗺𝗽𝗶𝗹𝗶𝗻𝗴 ' + gcdata.participants.length + ' 𝗖𝗼𝗻𝘁𝗮𝗰𝘁𝘀 𝗶𝗻𝘁𝗼 𝗮 𝗩𝗰𝗳...');
        ...
        case "leave":
          {
            ...
            await client.sendMessage(m.chat, {
              text: '𝗚𝗼𝗼𝗱𝗯𝘆𝗲 𝗲𝘃𝗲𝗿𝘆𝗼𝗻𝗲👋. 𝗖𝗹𝗶𝗻𝘁𝗼𝗻-𝗔𝗶 𝗶𝘀 𝗟𝗲𝗮𝘃𝗶𝗻𝗴 𝘁𝗵𝗲 𝗚𝗿𝗼𝘂𝗽 𝗻𝗼𝘄...',
 ...
 break;
  ...
  Message ${q ? q : ''}*\n\n`;
        ...
        case 'runtime':
          client.sendMessage(m.chat, {
            text: `𝗖𝗹𝗶𝗻𝘁𝗼𝗻 𝗵𝗮𝘀 𝗯𝗲𝗲𝗻 𝗿𝘂𝗻𝗻𝗶𝗻𝗴 𝘀𝗶𝗻𝗰𝗲 ${runtime(process.uptime())}`,
            contextInfo: {
              externalAdReply: {
                showAdAttribution: true,
                title: '𝗩𝗜𝗡𝗜𝗭𝗜𝗔𝗭-𝗫𝗠𝗗',
        ...
        case "photo":
          {
            ...
            exec(`ffmpeg -i ${media} ${mokaya}`, err => {
              ...
              client.sendMessage(m.chat, {
                image: buffer,
                caption: `𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗱 𝗯𝘆 𝗖𝗹𝗶𝗻𝘁𝗼𝗻-𝗕𝗼𝘁`
              }, {
                quoted: m
              });
